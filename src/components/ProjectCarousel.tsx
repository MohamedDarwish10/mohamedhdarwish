    ...
    <div className="relative w-full">
      <div className="overflow-hidden rounded-lg shadow-lg" ref={emblaRef}>
        <div className="flex transition-transform duration-500 ease-out">
          {images.map((image, index) => (
            <div key={index} className="flex-[0_0_100%] min-w-0 relative aspect-[19/10] bg-navy-50 dark:bg-navy-900 overflow-hidden">
      ...
      {images.length > 1 && (
        <>
          <button
            onClick={scrollPrev}
            className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-navy-900/50 hover:bg-navy-900/80 text-white rounded-full transition-colors duration-200 z-10 backdrop-blur-sm"
          ...
          <button
            onClick={scrollNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-navy-900/50 hover:bg-navy-900/80 text-white rounded-full transition-colors duration-200 z-10 backdrop-blur-sm"
